...
class Add extends \WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'pets_add', // Base ID
			esc_html__( 'Pet - Add', 'pets' ), // Name
			array( 'description' => esc_html__( 'Form to add new pets', 'pets' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		pets_locate_template( 'add-form.php', true, false );
		echo '</div>';
	...
	public function form( $instance ) {
		$title = ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( 'Add a New Pet', 'pets' );
		?>
		<p>
